...
# sphinx-quickstart on Tue Mar 28 11:03:35 2017.
#
...
copyright = '2010-2024, Christoph Reller'
...
latex_documents = [
    (master_doc, 'TikZSphinxExtension.tex', 'TikZ Sphinx Extension Documentation',
...
man_pages = [
    (master_doc, 'tikzsphinxextension', 'TikZ Sphinx Extension Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'TikZSphinxExtension', 'TikZ Sphinx Extension Documentation',
     author, 'TikZSphinxExtension', 'One line description of project.',
     'Miscellaneous'),
]
...
# Ignore missing Intersphinx documentation for the following packages:
#   * docutils
